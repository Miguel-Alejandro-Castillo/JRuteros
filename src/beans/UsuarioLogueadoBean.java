...
public class UsuarioLogueadoBean {
	...
	public String editarUsuario() {
		...
		FacesContext context = FacesContext.getCurrentInstance();
		if ((!this.getPasswordAnt().isEmpty()) && (!this.getPasswordNew().isEmpty())) {
			if (!this.getPasswordAnt().equals(this.getPassword())) {
				...
				if ((!this.getUsuario().equals(user.getUsuario()))
						&& (Factory.daoUsuario().buscar(this.getUsuario()) != null)) {
		...
		} else if ((!this.getPasswordAnt().isEmpty()) && (this.getPasswordNew().isEmpty())) {
